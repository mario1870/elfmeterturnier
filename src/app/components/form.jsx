...
export default function Form(props) {
    ...
    const handlePayment = async (e) => {
        ...
        if (teamname !== '' && kontaktperson !== '' && emailadresse !== '') {
    ...
    return(
        ...
        <div>
          ...
          <motion.div className="flex flex-col items-center justify-center pt-12" initial={{ scale: 0 }}  animate={{ scale: 1 }}  transition={{ delay: 0.1, duration: 0.5 }}>
          ...
          <ul className="flex justify-center px-20 py-4">
